...
<body>
    <div id="wrapper">
        <div id="header">
            <c:choose>
                <c:when
                    test="${sessionScope.login_user != null && sessionScope.login_user.admin_flag == 1}">
                    <div id="header_menu">
                        <h1>
                ...
                <c:when
                    test="${sessionScope.login_user != null && sessionScope.login_user.admin_flag == 0}">
                    <div id="header_menu">
                        <h1>
                            <a id="hello" href="<c:url value='/' />">ハロー！My ペット</a>
                        </h1>&nbsp;&nbsp;&nbsp;
                ...
                <c:otherwise>
                    <div id="header_menu">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <div id="user_name">
                            <a href="<c:url value='/login' />">ログイン</a>&nbsp;&nbsp; <a
                                href="<c:url value='/users/new' />">新規登録</a>
                        </div>
                    </div>
                </c:otherwise>
            </c:choose>
